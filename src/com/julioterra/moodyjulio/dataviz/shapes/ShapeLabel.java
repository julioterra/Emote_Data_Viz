...
public class ShapeLabel extends ShapeColor {
	...
	protected boolean label_toggle_mouse_over;
	protected boolean label_toggle_mouse_clicked;
	protected boolean description_toggle_mouse_over;
	protected boolean description_toggle_mouse_clicked;
...
//					PApplet.println("Mouse Clicked - toggle on");
	...
	public void setShiftAllMouseClicked(float hue_shift, float saturation_shift, float brightness_shift, float scale_shift, boolean label_shift_mouse_clicked, boolean description_shift_mouse_clicked) {
