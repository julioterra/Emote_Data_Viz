...
public class Panel extends ShapeRect {
	...
	public void addDropDownButton(String id, int x, int y, int width, int height, String text, int color, int font_number, int align_mode){
	...
	public void addMouseOverActionPanel(String action_id, Object object, String method_name){
		...
		while (text_item_entries.hasNext()) {
			Map.Entry<String, ShapeRectText> entry = (Map.Entry<String, ShapeRectText>) text_item_entries.next();
	    	ShapeRectText updated_button = entry.getValue();	 
			updated_button.addMouseOverAction(action_id, object, method_name);
		}
	}
