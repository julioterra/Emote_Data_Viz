...
import com.julioterra.moodyjulio.dataviz.shapes.PieLine;
...
public class MoodyJulioDataViz extends PApplet {
	...
	public void setup() {
		...
		lines = new PieLine[height_heart.length];
		...
		for (int i = 0; i < lines.length; i++){
			...
			lines[i] = new PieLine(width/2, height/2, height_heart[i], 10, (float) ((360/lines.length)/360.0), lastAng, cur_color_line);
