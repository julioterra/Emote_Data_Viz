...
public class DataPieEmotion extends Data {
	...
	public DataPieEmotion(String date_stamp, String time_stamp, String date_end,  String time_end, String emotion_type, String emotion_intensity,
	...
	public DataPieEmotion(Date date_stamp, Time time_stamp, Date date_end,  Time time_end) {
		super();
		this.setTime(date_stamp, time_stamp, date_end, time_end);
		this.setAllNonTime(0, 0, "", "", "", "", "", "");
	}

	public DataPieEmotion(String[] new_data) {
		super();
	...
	public DataPieEmotion(DataPieEmotion new_data) {
		super();
	...
	public void setBasic(Date date_stamp, Time time_stamp, Date date_end, Time time_end, String name, String description, float emotion_type,
	...
	public float getEmotion_intensity() {
	...
	public DataPieEmotion copy() {
		DataPieEmotion new_data = new DataPieEmotion();
